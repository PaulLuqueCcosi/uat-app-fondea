/**
 * Proxy para analytics de portfolio.
 * Rutea /api/admin/kpis/portfolio/analytics/distribution-by-term
 *     → backend /api/v1/admin/portfolio/analytics/distribution-by-term
 */
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ path: string[] }> }) {
  ...
  try {
    const url = `${BACKEND_URL}/api/v1/admin/portfolio/analytics/${analyticsPath}${query}`;
