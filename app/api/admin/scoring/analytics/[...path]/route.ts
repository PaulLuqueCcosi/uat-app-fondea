/**
 * Proxy para analytics de scoring/riesgo (R42-R44).
 * Rutea /api/admin/scoring/analytics/approval-rate
 *     → backend /api/v1/admin/scoring/analytics/approval-rate
 */
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ path: string[] }> }) {
  ...
  try {
    const url = `${BACKEND_URL}/api/v1/admin/scoring/analytics/${analyticsPath}${query}`;
