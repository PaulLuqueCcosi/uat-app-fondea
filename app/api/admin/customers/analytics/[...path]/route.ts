/**
 * Proxy para analytics de customers (R34).
 * Rutea /api/admin/customers/analytics/passport-segmentation
 *     → backend /api/v1/admin/customers/analytics/passport-segmentation
 */
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ path: string[] }> }) {
  ...
  try {
    const url = `${BACKEND_URL}/api/v1/admin/customers/analytics/${analyticsPath}${query}`;
