/**
 * Proxy para analytics de cobranza (R26-R30).
 * Rutea /api/admin/collections/analytics/npl-by-city
 *     → backend /api/v1/admin/collections/analytics/npl-by-city
 */
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ path: string[] }> }) {
  ...
  try {
    const url = `${BACKEND_URL}/api/v1/admin/collections/analytics/${analyticsPath}${query}`;
