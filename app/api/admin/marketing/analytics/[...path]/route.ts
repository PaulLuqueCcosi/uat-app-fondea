/**
 * Proxy para analytics de marketing (R37-R41).
 * Rutea /api/admin/marketing/analytics/kyc-first-attempt
 *     → backend /api/v1/admin/marketing/analytics/kyc-first-attempt
 */
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ path: string[] }> }) {
  ...
  try {
    const url = `${BACKEND_URL}/api/v1/admin/marketing/analytics/${analyticsPath}${query}`;
