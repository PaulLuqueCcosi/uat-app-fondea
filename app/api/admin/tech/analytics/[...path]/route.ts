/**
 * Proxy para analytics de tecnología y APIs (R45, R46, R48).
 * Rutea /api/admin/tech/analytics/kyc-processing-time
 *     → backend /api/v1/admin/tech/analytics/kyc-processing-time
 */
...
export async function GET(request: NextRequest, { params }: { params: Promise<{ path: string[] }> }) {
  ...
  try {
    const url = `${BACKEND_URL}/api/v1/admin/tech/analytics/${analyticsPath}${query}`;
