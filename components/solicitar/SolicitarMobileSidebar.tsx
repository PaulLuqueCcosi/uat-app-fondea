...
import { FunnelLoanSummaryCard } from './SolicitarLoanSummaryCard';

interface FunnelMobileSidebarProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function FunnelMobileSidebar({ open, onOpenChange }: FunnelMobileSidebarProps) {
